...
const FriendsPendingRequests = () => {
  ...
  const fetchPendingRequests = async () => {
    try {
      const res = await fetch(`https://194.90.158.74/cgroup81/test2/tar1/api/friends/pending-sent/${userId}`);
  ...
  const fetchReceivedRequests = async () => {
    try {
      const res = await fetch(`https://194.90.158.74/cgroup81/test2/tar1/api/friends/pending-received/${userId}`);
  ...
  const handleAcceptRequest = async (senderID, receiverID) => {
    try {
      const res = await fetch("https://194.90.158.74/cgroup81/test2/tar1/api/friends/accept", {
        method: "PUT",
        headers: {
  ...
  const updateRequestStatus = async (senderID, receiverID, action) => {
    try {
      const res = await fetch("https://194.90.158.74/cgroup81/test2/tar1/api/friends/cancel", {
        method: "PUT",
        headers: {
          "Content-Type": "application/json"
        },
